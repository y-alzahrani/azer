...
قواعد صارمة:
- اكتب باللغة العربية بشكل أساسي
...
- اعرض الأرقام بالوحدة الأنسب للقارئ (مليار أو ترليون) وليس بالملايين أو الألوف دائماً. مثال: 1,346,930 مليون ريال = 1.345 ترليون ريال. مثال آخر: 3,475 مليون ريال = 3.48 مليار ريال
- استخدم المصطلحات العربية الصحيحة والشائعة في التقارير المالية، ولا تُعرِّب الكلمات الأجنبية بالنقحرة (transliteration). عند عدم وجود ترجمة شائعة للمصطلح الأجنبي اذكر المصطلح العربي واذكر المصطلح الأجنبي بين قوسين.
...
- اكتب "الربع الأول من عام 2026" وليس "الربع الأول 2026" عند الإشارة إلى الفترات الزمنية
