  ...
  const metrics = [
    {
      name: 'الإيرادات',
      nameEn: 'Revenue',
      definition: 'إجمالي المبالغ التي تحققها الشركة من بيع منتجاتها أو خدماتها.',
    ...
    },
    {
      name: 'إجمالي الربح',
      nameEn: 'Gross Profit',
      definition: 'المبلغ المالي الذي تحققه الشركة من مبيعاتها بعد طرح تكلفة السلع أو الخدمات المباشرة المباعة، وذلك قبل خصم المصاريف الإدارية والتشغيلية والضرائب.',
      high: 'الشركة تبيع منتجاتها بسعر يزيد كثيرًا عن تكلفتها المباشرة',
      low: 'تكلفة إنتاج البضائع أو تقديم الخدمات قريبة جدًا من قيمة الإيرادات المحققة',
    },
    {
      name: 'الربح التشغيلي',
      nameEn: 'Operating Income',
      definition: 'الربح الذي تحققه الشركة من نشاطها التجاري الأساسي قبل الفوائد والضرائب.',
      high: 'النشاط الأساسي للشركة مربح',
      low: 'النشاط الأساسي لا يحقق مكاسب كافية لتغطية المصاريف الإدارية واليومية',
    },
    {
      name: 'صافي الربح',
      nameEn: 'Net Income',
    ...
    },
    {
      ...
      definition: 'مؤشر مالي يقيس كفاءة الشركة في توليد الأرباح من الأموال التي استثمرها المساهمون.',
      high: 'الشركة لديها قدرة ممتازة على توليد أرباح قوية باستخدام أموال المساهمين',
      low: 'الإدارة تفشل في استغلال رأس المال المتاح لتحقيق أرباح مجدية',
    },
    {
